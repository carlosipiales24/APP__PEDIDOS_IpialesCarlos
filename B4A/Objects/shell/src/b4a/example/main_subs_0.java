...
addclientepage.myClass = BA.getDeviceClass ("b4a.example.addclientepage");
addpedidopage.myClass = BA.getDeviceClass ("b4a.example.addpedidopage");
clientes.myClass = BA.getDeviceClass ("b4a.example.clientes");
cliente.myClass = BA.getDeviceClass ("b4a.example.cliente");
pedido.myClass = BA.getDeviceClass ("b4a.example.pedido");
