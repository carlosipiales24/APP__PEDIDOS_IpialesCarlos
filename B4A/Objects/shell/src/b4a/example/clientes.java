...
public static Object[] GetGlobals(RemoteObject _ref) throws Exception {
		return new Object[] {"apiJob",_ref.getField(false, "_apijob"),"apiURL",_ref.getField(false, "_apiurl"),"jsonParser",_ref.getField(false, "_jsonparser"),"Root",_ref.getField(false, "_root"),"xui",_ref.getField(false, "_xui")};
}
}